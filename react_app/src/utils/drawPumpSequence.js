import { drawBaseSintetica, drawPasta, drawEspacador } from "./functionsToDrawPumpSequence";
...
/* Function to draw all Geometry */
  export const drawAllPumpSequence = () => {
    let shapeAllGeometries = []
    shapeAllGeometries.push(...drawInternalGeometry(), ...drawExternalGeometry(), ...drawBaseSintetica, ...drawPasta, ...drawEspacador )
