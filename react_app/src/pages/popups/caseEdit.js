...
function EditCase(props) {
    ...
    if (pageState == 0) {
        return (
            <div>
                <p className="title_Modal">Criar um novo Fluido</p>
                <div className="back-modal">
                    <label className="label"> identificação </label>
                    <div>
                        <label className="label">nome:</label>
                        <input className="input-fluid-nome" type="text" placeholder="nome" />
                        <label className="color">cor:</label>
                        <label className="label-grupo">Grupo:</label>
                        <select className="Select_Identity">
        ...
        return (
            ...
            <div>
                ...
                <select>
                    ...
                    <option>Pressão e Temperatura</option>
                </select>
